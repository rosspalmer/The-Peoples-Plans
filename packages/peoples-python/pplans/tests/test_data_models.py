...
from pplans.data_models import RawMessageData
...
class TestRawMessage:
    ...
    def test_decode(self):
        ...
        event = loads(event_json, object_hook=RawMessageData.decode_function)
    ...
    def test_encode(self):
        ...
        event = RawMessageData("A-1", "ask@merch.com", "Do you know if you need stuff?")
